  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-purple-600 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-purple-600 focus:bg-purple-600 ease">
              <span className="sr-only">Open Contact form TalkHub Center</span>
              <Transition
                show={!open}
              ...
              <Disclosure.Panel className=" flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                <div className="flex flex-col items-center justify-center h-32 p-5 bg-purple-600">
                  ...
                  <p className="text-white opacity-50">
                    We usually respond in a 24 hours
                  </p>
                </div>
